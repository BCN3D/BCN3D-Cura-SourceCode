...
class MachineSelectPage(InfoPage):
    ...
    def StoreData(self):
        ...
        if self.BCN3DSigmaRadio.GetValue():
        ...
        elif self.BCN3DPlusRadio.GetValue():
            profile.putMachineSetting('machine_center_is_zero', 'False')
            profile.putProfileSetting('nozzle_size', '0.4')
            profile.putProfileSetting('fan_full_height', '5.0')
            profile.putMachineSetting('extruder_offset_x1', '0.0')
            ...
            profile.putMachineSetting('serial_baud', 'AUTO')
            profile.putMachineSetting('gcode_flavor', 'RepRap (Marlin/Sprinter)')
        elif self.BCN3DRRadio.GetValue():
            profile.putMachineSetting('machine_center_is_zero', 'False')
            profile.putProfileSetting('nozzle_size', '0.4')
            profile.putProfileSetting('fan_full_height', '5.0')
            profile.putMachineSetting('extruder_offset_x1', '0.0')
            ...
            profile.putMachineSetting('serial_baud', 'AUTO')
            profile.putMachineSetting('gcode_flavor', 'RepRap (Marlin/Sprinter)')
        elif self.Ultimaker2Radio.GetValue() or self.Ultimaker2GoRadio.GetValue() or self.Ultimaker2ExtRadio.GetValue() or self.Ultimaker2PlusRadio.GetValue() or self.Ultimaker2PlusExtRadio.GetValue():
